...
def parse_args():
    ...
    parser.add_argument('--img', type=str, default=None, help='Image file')
    parser.add_argument('--img-folder', type=str, default=None, help='Image folder')
    parser.add_argument(
        '--method',
        default='gradcam',
...
def main():
    ...
    if args.img:
        ...
        for img in os.listdir(args.img_folder):
            images.append(os.path.join(args.img_folder, img))
    else:
